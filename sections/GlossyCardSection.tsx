    ...
    <section className='flex flex-col md:flex-row mb-10 gap-8'>
      <div className='flex flex-col gap-2 md:basis-1/2'>
        ...
        <div className='flex justify-center gap-2 items-end'>
          <GlossyCard img={glossy1.src} className='h-44 w-36 md:h-80 md:w-64' title='Flexible Leases' />
          <GlossyCard img={glossy2.src} className='h-36 w-40 md:h-64 md:w-60' title='7-Day Happiness
Guaranteed' />
        </div>

        <div className='flex justify-center gap-2 items-start'>
          <GlossyCard img={glossy3.src} className='h-32 w-28 md:h-56 md:w-52' title='Monthly House Cleaning' />
          <GlossyCard img={glossy4.src} className='h-44 w-40 md:h-80 md:w-72' title='Choose Your Own Roommate' />
        </div>
      </div>


      <div className='flex flex-col gap-5 md:basis-1/2 md:justify-center md:items-center'>
        <h3 className='font-bold text-2xl text-center text-black md:text-left md:text-4xl'>
          Flexibility and options to suit your lifestyle.
        </h3>
        <p className='font-thin text-[#6B7280] text-sm text-center md:text-left md:font-thin'>
