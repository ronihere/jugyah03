...
export default function Navbar() {
    return (
        <nav className='absolute top-0 w-full py-6 px-4 lg:px-10'>
            <div className='flex items-center justify-between'>
                <div className="cursor-pointer">
                    <img src={BrandLogo.src} alt='brand logo' className='w-[50%] relative lg:w-[80%]'></img>
                </div>
                <div className="group lg:hidden relative">
                ...
                <div className='hidden lg:flex space-x-6 font-semibold'>
                    ...
                    <Link href="" className='hover:text-slate-300'>Our Mission</Link>
                    <Link href="" className='hover:text-slate-300'>About Us</Link>
                    <Link href="" className='hover:text-slate-300'>LandLords</Link>
                    <Link href="" className='hover:text-slate-300'>Tenant</Link>
                    <Link href="" className='hover:text-slate-300'>Contact Us</Link>
                </div>
